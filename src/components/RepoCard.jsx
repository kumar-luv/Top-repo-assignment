  ...
  return (
    <div className="flex w-full m-3 p-3 border border-gray-300 rounded-md shadow-md hover:shadow-2xl transition duration-500">
      ...
      <div className="flex flex-col ml-4">
        ...
        <p className="text-left font-medium text-2xl mt-2">{repo?.description}</p>
        <div className="flex mt-8 gap-8">
          ...
          <p className="mt-2 text-yellow-500">Stars: {repo?.stargazers_count}</p>
          <p className="mt-2 text-yellow-500">Issues: {repo?.open_issues_count}</p>
        </div>
